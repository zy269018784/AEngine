...
RHIApplicationTexture2DCombinedImageSampler::RHIApplicationTexture2DCombinedImageSampler()
    : RHIApplication()
{
...
void RHIApplicationTexture2DCombinedImageSampler::Init()
{
    std::cout << "1" << std::endl;
    CreateVBO();
    CreateEBO();
...
void RHIApplicationTexture2DCombinedImageSampler::CreateVBO()
{
...
void RHIApplicationTexture2DCombinedImageSampler::CreateEBO()
{
    RHIEBO = pRHI->RHICreateBuffer(RHIBufferType::IndexBuffer, RHIBufferUsageFlag::IndexBuffer, sizeof(Index), Index);
}

void RHIApplicationTexture2DCombinedImageSampler::CreateTexture()
{
...
void RHIApplicationTexture2DCombinedImageSampler::CreateSRB()
{
...
void RHIApplicationTexture2DCombinedImageSampler::CreateVertexDescriptioin()
{
#if 1
    /*
        使用VBO1
...
void RHIApplicationTexture2DCombinedImageSampler::CreateGraphicsPipeline()
{
#if 1
...
void RHIApplicationTexture2DCombinedImageSampler::Draw()
{
    float x = 0;
    float y = 0;
    float w = 0;
