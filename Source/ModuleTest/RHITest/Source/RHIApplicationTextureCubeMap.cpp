...
void RHIApplicationTextureCubeMap::CreateTexture()
{
   ...
   //}
    ...
    RHITextureCubeMap = pRHI->RHICreateTextureCube(RHIPixelFormat::PF_R8G8B8A8_UNORM, RHITextureUsageFlag::SampledTexture,1, texWidth, texHeight, TextureData.data());
#if 1
...
void RHIApplicationTextureCubeMap::CreateSRB()
{
    ...
    SRB->SetBindings({
            RHIShaderResourceBinding::SampledTexture(0, RHIShaderType::Fragment, RHITextureCubeMap, RHISampler_)
    });
    SRB->Create();
}
