...
RHITexture* VulkanRHI::RHICreateTexture1D(RHIPixelFormat RHIPixelFormat, RHITextureUsageFlag InUsage, RHIImageLayout InLayout, std::uint32_t NumMips, std::uint32_t SizeX, void *Data)
{
	VulkanTexture* Texture =  new VulkanTexture(Devices[GPUIndex], RHITextureType::Texture1D, RHIPixelFormat, InUsage,
		InLayout, NumMips, SizeX, 1, 1, 1, Data);
	return Texture;
}


RHITexture* VulkanRHI::RHICreateTexture1DArray(RHIPixelFormat RHIPixelFormat, RHITextureUsageFlag InUsage, RHIImageLayout InLayout, std::uint32_t NumMips, std::uint32_t SizeX, std::uint32_t ArraySize, void *Data)
{
	VulkanTexture* Texture = new VulkanTexture(Devices[GPUIndex], RHITextureType::Texture1DArray, RHIPixelFormat, InUsage,
		InLayout, NumMips, SizeX, 1, 1, ArraySize, Data);
	return Texture;
}

RHITexture* VulkanRHI::RHICreateTexture2D(RHIPixelFormat RHIPixelFormat, RHITextureUsageFlag InUsage, RHIImageLayout InLayout, std::uint32_t NumMips, std::uint32_t SizeX, std::uint32_t SizeY, void *Data)
{
	VulkanTexture *Texture = new VulkanTexture(Devices[GPUIndex], RHITextureType::Texture2D, RHIPixelFormat, InUsage,
		InLayout, NumMips, SizeX, SizeY, 1, 1, Data);
	return Texture;
}

RHITexture* VulkanRHI::RHICreateTexture2DArray(RHIPixelFormat RHIPixelFormat, RHITextureUsageFlag InUsage, RHIImageLayout InLayout, std::uint32_t NumMips, std::uint32_t SizeX, std::uint32_t SizeY, std::uint32_t ArraySize, void *Data)
{
	VulkanTexture* Texture = new VulkanTexture(Devices[GPUIndex], RHITextureType::Texture2DArray, RHIPixelFormat, InUsage,
		InLayout, NumMips, SizeX, SizeY, 1, ArraySize, Data);
	return Texture;
	
}

RHITexture* VulkanRHI::RHICreateTexture3D(RHIPixelFormat RHIPixelFormat, RHITextureUsageFlag InUsage, RHIImageLayout InLayout, std::uint32_t NumMips, std::uint32_t SizeX, std::uint32_t SizeY, std::uint32_t SizeZ, void *Data)
{
	VulkanTexture* Texture = new VulkanTexture(Devices[GPUIndex], RHITextureType::Texture3D, RHIPixelFormat, InUsage,
		InLayout, NumMips, SizeX, SizeY, SizeZ, 1, Data);
	return Texture;
}

RHITexture* VulkanRHI::RHICreateTextureCube(RHIPixelFormat RHIPixelFormat, RHITextureUsageFlag InUsage, RHIImageLayout InLayout, std::uint32_t NumMips, std::uint32_t SizeX, std::uint32_t SizeY, void *Data)
{
	VulkanTexture* Texture = new VulkanTexture(Devices[GPUIndex], RHITextureType::TextureCubeMap, RHIPixelFormat, InUsage,
		InLayout, NumMips, SizeX, SizeY, 1, 6, Data);
	return Texture;
}

RHITexture* VulkanRHI::RHICreateTextureCubeArray(RHIPixelFormat RHIPixelFormat, RHITextureUsageFlag InUsage, RHIImageLayout InLayout, std::uint32_t NumMips, std::uint32_t SizeX, std::uint32_t SizeY, std::uint32_t ArraySize, void *Data)
{
	ArraySize *= 6;
