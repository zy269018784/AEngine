...
enum class RHIEXPORT RHIImageLayout {
    ...
    RHI_IMAGE_LAYOUT_READ_ONLY_OPTIMAL = 1000314000,
    RHI_IMAGE_LAYOUT_ATTACHMENT_OPTIMAL = 1000314001,
    RHI_IMAGE_LAYOUT_RENDERING_LOCAL_READ = 1000232000,
    RHI_IMAGE_LAYOUT_PRESENT_SRC_KHR = 1000001002,
    RHI_IMAGE_LAYOUT_VIDEO_DECODE_DST_KHR = 1000024000,
    RHI_IMAGE_LAYOUT_VIDEO_DECODE_SRC_KHR = 1000024001,
    RHI_IMAGE_LAYOUT_VIDEO_DECODE_DPB_KHR = 1000024002,
    RHI_IMAGE_LAYOUT_SHARED_PRESENT_KHR = 1000111000,
    ...
    RHI_IMAGE_LAYOUT_VIDEO_ENCODE_DST_KHR = 1000299000,
    RHI_IMAGE_LAYOUT_VIDEO_ENCODE_SRC_KHR = 1000299001,
    RHI_IMAGE_LAYOUT_VIDEO_ENCODE_DPB_KHR = 1000299002,
    RHI_IMAGE_LAYOUT_ATTACHMENT_FEEDBACK_LOOP_OPTIMAL_EXT = 1000339000,
    RHI_IMAGE_LAYOUT_TENSOR_ALIASING_ARM = 1000460000,
    RHI_IMAGE_LAYOUT_VIDEO_ENCODE_QUANTIZATION_MAP_KHR = 1000553000,
    RHI_IMAGE_LAYOUT_ZERO_INITIALIZED_EXT = 1000620000,
    ...
    RHI_IMAGE_LAYOUT_RENDERING_LOCAL_READ_KHR = RHI_IMAGE_LAYOUT_RENDERING_LOCAL_READ,
    ...
    RHI_IMAGE_LAYOUT_READ_ONLY_OPTIMAL_KHR = RHI_IMAGE_LAYOUT_READ_ONLY_OPTIMAL,
    RHI_IMAGE_LAYOUT_ATTACHMENT_OPTIMAL_KHR = RHI_IMAGE_LAYOUT_ATTACHMENT_OPTIMAL,
    RHI_IMAGE_LAYOUT_MAX_ENUM = 0x7FFFFFFF
};


enum class RHIEXPORT RHIAttachmentLoadOp : std::uint32_t
{
...
enum class RHIEXPORT RHIAttachmentStoreOp : std::uint32_t
{
	RHI_ATTACHMENT_STORE_OP_STORE = 0,
	RHI_ATTACHMENT_STORE_OP_DONT_CARE = 1,
	RHI_ATTACHMENT_STORE_OP_NONE = 1000301000,
	RHI_ATTACHMENT_STORE_OP_NONE_KHR = RHI_ATTACHMENT_STORE_OP_NONE,
	RHI_ATTACHMENT_STORE_OP_NONE_QCOM = RHI_ATTACHMENT_STORE_OP_NONE,
	RHI_ATTACHMENT_STORE_OP_NONE_EXT = RHI_ATTACHMENT_STORE_OP_NONE,
