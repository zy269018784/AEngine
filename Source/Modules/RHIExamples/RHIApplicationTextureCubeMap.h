...
class RHIApplicationTextureCubeMap : public RHIApplication
{
public:
    RHIApplicationTextureCubeMap(GLFWwindow* Window);
    ~RHIApplicationTextureCubeMap();
private:
    virtual void Init();
    virtual void Draw();
    void CreateVBO();
...
private:
    RHITexture* RHITextureCubeMap = nullptr;
