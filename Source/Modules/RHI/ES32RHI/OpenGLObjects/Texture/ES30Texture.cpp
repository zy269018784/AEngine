    ...
    */
    ...
    case RHITextureType::Texture1D:
        ...
        */
        ...
        std::cout << "ES30Texture::Update 1D " << MipmapLevel << " XOffset " <<  XOffset << " Width " << Width << " Format " << Format << " Type " <<  Type << std::endl;
        break;
    case RHITextureType::Texture1DArray:
        /*
        ...
        */
        ...
        std::cout << "ES30Texture::Update 1D Array MipmapLevel " << MipmapLevel << " XOffset " << XOffset << " YOffset " << YOffset << " Width " << Width << " Height " << Height << " Format " << Format << " Type " << Type << std::endl;
        break;
    case RHITextureType::Texture2D:
        /*
            更新整个2D纹理区域.
