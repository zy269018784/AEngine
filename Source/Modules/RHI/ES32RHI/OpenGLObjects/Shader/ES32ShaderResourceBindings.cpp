...
void ES32ShaderResourceBindings::CreateUBO(int BindingPoint, GLuint Handle)
{
	glBindBufferBase(GL_UNIFORM_BUFFER, BindingPoint, Handle);
}

void ES32ShaderResourceBindings::CreateSSBO(int BindingPoint, GLuint Handle)
{
...
#if 0
void ES32ShaderResourceBindings::Create()
{
	...
	std::cout << "ES32ShaderResourceBindings ActiveTextureUnits " << ActiveTextureUnits << std::endl;
}
#endif
