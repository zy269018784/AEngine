...
public:
	...
	*/
	...
	virtual RHITexture* RHICreateTexture1DArray(RHIAttachmentType InAttachmentType, RHIPixelFormat RHIPixelFormat, std::uint32_t NumMips, std::uint32_t SizeX, std::uint32_t ArraySize, void *Data = nullptr) final override;
	virtual RHITexture* RHICreateTexture2D(RHIAttachmentType InAttachmentType, RHIPixelFormat RHIPixelFormat, std::uint32_t NumMips, std::uint32_t SizeX, std::uint32_t SizeY, void *Data = nullptr) final override;
	virtual RHITexture* RHICreateTexture2DArray(RHIAttachmentType InAttachmentType, RHIPixelFormat RHIPixelFormat, std::uint32_t NumMips, std::uint32_t SizeX, std::uint32_t SizeY, std::uint32_t ArraySize, void *Data = nullptr) final override;
	virtual RHITexture* RHICreateTexture3D(RHIAttachmentType InAttachmentType, RHIPixelFormat RHIPixelFormat, std::uint32_t NumMips, std::uint32_t SizeX, std::uint32_t SizeY, std::uint32_t SizeZ, void *Data = nullptr) final override;
	virtual RHITexture* RHICreateTextureCube(RHIAttachmentType InAttachmentType, RHIPixelFormat RHIPixelFormat, std::uint32_t NumMips, std::uint32_t SizeX, std::uint32_t SizeY, void *Data = nullptr) final override;
	virtual RHITexture* RHICreateTextureCubeArray(RHIAttachmentType InAttachmentType, RHIPixelFormat RHIPixelFormat, std::uint32_t NumMips, std::uint32_t SizeX, std::uint32_t SizeY, std::uint32_t ArraySize, void *Data = nullptr) final override;
