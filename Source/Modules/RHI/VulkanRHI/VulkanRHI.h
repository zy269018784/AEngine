...
public:
	...
	*/
	...
	virtual RHITexture* RHICreateTexture1D(RHIPixelFormat RHIPixelFormat, RHITextureUsageFlag InUsage, RHIImageLayout InLayout, std::uint32_t NumMips, std::uint32_t SizeX, void *Data = nullptr) final override;
	virtual RHITexture* RHICreateTexture1DArray(RHIPixelFormat RHIPixelFormat, RHITextureUsageFlag InUsage, RHIImageLayout InLayout, std::uint32_t NumMips, std::uint32_t SizeX, std::uint32_t ArraySize, void *Data = nullptr) final override;
	virtual RHITexture* RHICreateTexture2D(RHIPixelFormat RHIPixelFormat, RHITextureUsageFlag InUsage, RHIImageLayout InLayout, std::uint32_t NumMips, std::uint32_t SizeX, std::uint32_t SizeY, void *Data = nullptr) final override;
	virtual RHITexture* RHICreateTexture2DArray(RHIPixelFormat RHIPixelFormat, RHITextureUsageFlag InUsage, RHIImageLayout InLayout, std::uint32_t NumMips, std::uint32_t SizeX, std::uint32_t SizeY, std::uint32_t ArraySize, void *Data = nullptr) final override;
	virtual RHITexture* RHICreateTexture3D(RHIPixelFormat RHIPixelFormat, RHITextureUsageFlag InUsage, RHIImageLayout InLayout, std::uint32_t NumMips, std::uint32_t SizeX, std::uint32_t SizeY, std::uint32_t SizeZ, void *Data = nullptr) final override;
	virtual RHITexture* RHICreateTextureCube(RHIPixelFormat RHIPixelFormat, RHITextureUsageFlag InUsage, RHIImageLayout InLayout, std::uint32_t NumMips, std::uint32_t SizeX, std::uint32_t SizeY, void *Data = nullptr) final override;
	virtual RHITexture* RHICreateTextureCubeArray(RHIPixelFormat RHIPixelFormat, RHITextureUsageFlag InUsage, RHIImageLayout InLayout, std::uint32_t NumMips, std::uint32_t SizeX, std::uint32_t SizeY, std::uint32_t ArraySize, void *Data = nullptr) final override;
