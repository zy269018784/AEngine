...
#else
    Texture = new D3D11Texture(Device, RHITextureType::Texture2D, RHIPixelFormat::PF_R8G8B8A8_UNORM, 1, TEXTURE_WIDTH, TEXTURE_HEIGHT, 1, 1, textureData.data());
    g_texture = (ID3D11Texture2D*)Texture->Handle;
#endif
